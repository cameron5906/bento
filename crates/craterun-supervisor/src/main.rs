...
use craterun_core::types::SupervisorSockInfo;
use craterun_core::{AppId, SupervisorState};
use craterun_runtime::adapters::existing_docker::ExistingDockerAdapter;
...
fn write_sock_info(
    paths: &craterun_core::paths::AppPaths,
    port: u16,
    token: &str,
) -> anyhow::Result<()> {
