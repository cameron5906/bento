...
impl From<&BentoError> for UserFacingError {
    fn from(err: &BentoError) -> Self {
        match err {
            BentoError::DiskSpaceLow {
                required_bytes,
                available_bytes,
            } => {
            ...
            BentoError::WslNotAvailable(detail) => UserFacingError {
            ...
            BentoError::WslFeatureRequiresReboot => UserFacingError {
            ...
            BentoError::VirtualizationDisabled => UserFacingError {
            ...
            BentoError::ImageImportFailed { service, detail } => UserFacingError {
            ...
            BentoError::ContainerStartFailed { service, detail } => UserFacingError {
            ...
            BentoError::ProxyBindFailed { port } => UserFacingError {
            ...
            BentoError::RuntimeNotFound(detail) => UserFacingError {
            ...
            BentoError::BundleReadError(detail) => UserFacingError {
