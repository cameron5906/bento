...
impl ExistingDockerAdapter {
    ...
    fn container_name(app_id: &AppId, service: &str) -> String {
        format!("craterun-{}-{}", app_id.as_str().replace('.', "-"), service)
    }

    fn network_name(app_id: &AppId) -> String {
        format!("craterun-{}", app_id.as_str().replace('.', "-"))
    }
}
...
impl RuntimeAdapter for ExistingDockerAdapter {
    ...
    async fn start_app(&self, plan: &RuntimePlan) -> Result<(), CrateRunError> {
        for service in &plan.services {
            ...
            let output = Command::new("docker")
                ...
                .output()
                .await
                .map_err(|e| CrateRunError::ContainerStartFailed {
    ...
    async fn stop_app(&self, app_id: &AppId) -> Result<(), CrateRunError> {
        ...
        let output = Command::new("docker")
            ...
            .output()
            .await
            .map_err(|e| CrateRunError::RuntimeError(format!("docker ps failed: {}", e)))?;
    ...
    async fn get_container_status(
        ...
        let output = Command::new("docker")
            ...
            .output()
            .await
            .map_err(|e| CrateRunError::RuntimeError(format!("docker inspect failed: {}", e)))?;
    ...
    async fn get_logs(
        ...
        let containers: Vec<String> = if let Some(svc) = service {
            ...
            let output = Command::new("docker")
                ...
                .output()
                .await
                .map_err(|e| CrateRunError::RuntimeError(e.to_string()))?;
    ...
    async fn create_network(&self, app_id: &AppId) -> Result<(), CrateRunError> {
        ...
        let output = Command::new("docker")
            ...
            .output()
            .await
            .map_err(|e| CrateRunError::RuntimeError(format!("docker network create failed: {}", e)))?;
    ...
    async fn create_volume(
        ...
        let output = Command::new("docker")
            ...
            .output()
            .await
            .map_err(|e| CrateRunError::RuntimeError(format!("docker volume create failed: {}", e)))?;
